...
import { useImproveWithAIMutation } from "@/Tanstack-Query/useResumeMutation";
...
export function EntryForm({
  ...
  const { mutate: improveWithAIMutate, isPending: isImproving } =
    useImproveWithAIMutation();

  // Handler for improving the description
  const handleImproveDescription = async () => {
    ...
    improveWithAIMutate(
      ...
      {
        onSuccess: (improvedContent: string) => {
